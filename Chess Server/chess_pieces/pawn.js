...
class Pawn extends Piece {
  ...
  promotingPawn(gamePieces, pieceToChange) {

    let pawntoPromote = JSON.stringify(this);

    switch (pieceToChange) {

      case "queen":
        gamePieces[this.position] = new Queen(pawntoPromote);
        break;

      case "bisop":
        gamePieces[this.position] = new Bishop(pawntoPromote);
        break;

      case "knight":
        gamePieces[this.position] = new Knight(pawntoPromote);
        break;

      case "rook":
        gamePieces[this.position] = new Rook(pawntoPromote);
        break;
